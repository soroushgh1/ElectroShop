...
export const GetOneProduct = async (req, res) => {
  ...
  try {
    ...
    const product = await prisma.product.findUnique({ where: { code: productid }, select: { name: true, description: true, picture: true, price: true, quantity: true, code: true, created_at: true, updated_at: true, category: { select: { name: true, slug: true, created_at: true, updated_at: true } } } });
